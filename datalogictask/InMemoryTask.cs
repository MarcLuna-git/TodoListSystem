...
namespace ToDoListProcess.DL
{
    ...
    {   
        ...
        // user sample account po na pwede mag login
        ...
        public bool EditTask(int index, string newDescription, string username)
        {
            ...
            if (index >= 0 && index < userTasks.Count)
            {
                ...
                if (realIndex >= 0)
                {
                    tasks[realIndex] = new TaskItem(username, newDescription, oldTask.DateAndTime);
                    return true;
                }
            }
        ...
        public bool MarkAsDone(int index, string username)
        {
            ...
            if (index >= 0 && index < userTasks.Count)
            {
                ...
                {
                    tasks[realIndex] = new TaskItem(username, "[√] " + oldTask.Task, oldTask.DateAndTime);
                    return true;
                }
            }
